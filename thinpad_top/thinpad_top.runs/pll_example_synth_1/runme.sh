...
HD_PWD='E:/Xilinx_pro/thinpad_top/thinpad_top.runs/pll_example_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pll_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pll_example.tcl
